...
async function nextQ(){
  ...
  try{
    const res=await fetch('/api/salva',{
      ...
      body:JSON.stringify({sessione:curSess,stmt_id:id,stmt_text:q.text,vero:q.vero,esposizione:getEsposizione(id,curSess),heard:heardV,rating:ratingV})
    });
